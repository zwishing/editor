...
class SourcesPanelInternal extends React.Component<SourcesPanelProps> {
    ...
    render() {
        ...
        return <div className="maputnik-sources-panel">
...
const SourcesPanel = withTranslation()(SourcesPanelInternal);
