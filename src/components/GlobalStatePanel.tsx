...
const GlobalStatePanelInternal: React.FC<GlobalStatePanelProps> = (props) => {
    ...
    return (
        <div className="maputnik-settings-panel">
            <header className="maputnik-panel-header">
                <h1>{props.t("Global State")}</h1>
            </header>

            {variables.length === 0 &&
                <div className="maputnik-panel-section">
            ...
            {variables.length > 0 &&
                <table className="maputnik-table">
                    <thead>
                    </thead>
                    <tbody>
                        {variableFields}
...
const GlobalStatePanel = withTranslation()(GlobalStatePanelInternal);
export default GlobalStatePanel;
